...
train_arg.add_argument(
    ...
    "run_mode")
train_arg.add_argument(
    "--train_lr", type=float, default=3e-4, help=""
    "learning rate")
train_arg.add_argument(
...
train_arg.add_argument(
    "--SummaryWriter_base", type=str, default="../tensorboardX_logs/", help=""
    "save directory tensorboardX logs")
train_arg.add_argument(
    "--SummaryWriter_floder", type=str, default="MGCA-Net", help=""
    "save directory tensorboardX floder name")
